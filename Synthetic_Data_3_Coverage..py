...
filename1 = r'Synthetic_Data_3_Coverage '+ str(B) + r' ' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
# Groups A and B
Class_features = {3:0,56:1,78:2,90:3}

for i in range (0,500):#create rows
    row = [random.uniform(0, 100)  for i in range(100)]# 100 features between [-1,1]
    r = np.asarray(row)
    max = -1
